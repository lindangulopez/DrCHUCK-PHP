In {...$this -> course...} you can get to know Object oriented pattern in the PHP language, connect to a MySQL using the Portable Data Objects (PDO) library and issue SQL commands in the the PHP language.
